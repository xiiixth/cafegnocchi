...
window.addEventListener('scroll', function() {
  ...
  if (currentScrollPos > 50) { 
    ...
    navigationBar.classList.add('scroll-background');
  } else {
    
    navigationBar.classList.remove('scroll-background');
  }
});
...
window.addEventListener('scroll', function() {
  ...
  // Check the scroll position and add a class when scrolled
  if (window.scrollY > 0) {
...
window.addEventListener('scroll', function() {
  ...
  if (scrollPosition > 100) { 
    ...
    document.querySelector('.original-logo').style.display = 'none';
    document.querySelector('.alternate-logo').style.display = 'block';
  } else {
    navbar.classList.remove('fixed-nav');
    document.querySelector('.original-logo').style.display = 'block';
    document.querySelector('.alternate-logo').style.display = 'none';
  }
});

const loginButton = document.querySelector('.cc-contact-us');
let isVisible = true;
